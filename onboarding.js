...
export default function Onboarding() {
  ...
  return (
    <div style={{
      ...
      >
        <div style={{ borderRadius: "1rem", boxShadow: "0 4px 20px rgba(0,0,0,0.1)", backgroundColor: "white" }}>
            ...
            {current.buttons ? (
              <div style={{ marginTop: "1rem" }}>
                {current.buttons.map((btn, idx) => (
                  <button key={idx} style={{ width: "100%", margin: "0.5rem 0", padding: "0.75rem", border: "1px solid #ccc", borderRadius: "0.5rem" }}>
                    {btn}
                  </button>
                ))}
              </div>
